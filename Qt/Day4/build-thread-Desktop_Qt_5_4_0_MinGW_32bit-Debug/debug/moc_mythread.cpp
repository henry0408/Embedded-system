...
QT_MOC_LITERAL(3, 19, 8), // "UserData"
QT_MOC_LITERAL(4, 28, 1) // "i"

    },
    "MyThread\0mySignal\0\0UserData\0i"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->mySignal((*reinterpret_cast< UserData(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyThread::*_t)(UserData );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::mySignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyThread::mySignal(UserData _t1)
{
